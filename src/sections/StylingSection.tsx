  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="absolute right-[3vw] top-1/2 -translate-y-1/2 pointer-events-none z-[5]"
      >
        <img
        ...
        <div className="max-w-[42vw] lg:max-w-xl">
          ...
          <div ref={bodyRef}>
            <p className="text-cream/70 text-base lg:text-lg leading-relaxed max-w-md mb-8">
              Blowouts, silk press, soft waves, and updos—finished with heat protection and care.
            </p>
          </div>
